        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="dom">
                                            ...
                                            @if($attributes->count() > 0)
                                                <table
                                                    ...
                                                    @foreach($attributes as $attribute)
                                                        <tr>
                                                            <td style="width: 200px">{{$attribute -> name}}</td>
                                                            <td style="width: 300px">
                                                                <div class="btn-group" role="group"
                                                                    ...
                                                                    <a href="{{route('admin.product.attributes.delete',$attribute -> id)}}"
                                                        ...
                                                        <div class="row">
                                                            <button class="btn btn-primary">
                                                                <i class="la la-check-square-o"></i><a
                                                                    href="{{route('admin.product.attributes.create')}}"
                                                                    style="color: black">اضافة خاصيه جديده</a>
                                                            </button>
                                                        </div>
                                                    @endif
                                                    @endisset
                    ...
                    <div class="justify-content-center d-flex">
                       @if($attributes->count()>0) {!! $attributes -> links() !!} @endif
                    </div>
                </section>
            </div>
        </div>
