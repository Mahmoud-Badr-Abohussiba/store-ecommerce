                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> أضافة منتج جديد - الخطوه الثالثه</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number"
                                                                   class="form-control"
                                                                   placeholder=" {{$product->special_price}} "
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="special_price_type" class="select2 form-control" multiple>
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    <option class="active selected" value="{{$product->special_price_type}}">{{$product->special_price_type}}</option>
                                                ...
                                                <div class="row" >
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" id="price"
                                                                   class="form-control"
                                                                   placeholder="{{$product->special_price_start}}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" id="price"
                                                                   class="form-control"
                                                                   placeholder="{{$product->special_price_end}}"
