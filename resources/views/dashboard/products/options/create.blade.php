                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#"> الاختيارات </a>
                                </li>
                                <li class="breadcrumb-item active"> اضافة اختيار
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">  اضافة اختيار </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات الاختيارات</h4>
